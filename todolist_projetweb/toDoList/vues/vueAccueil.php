...
<div class="row align-items-start">
    ...
    foreach ($tabListeTaches
        ...
        <div class="col-12 col-md-6 col-lg-6 text-center">
            <figcaption class="ListePublique" style="height: 300">
                ...
                <form method='post' action="index.php?action=AfficherDetailListe" class="position-absolute" style="margin-top: 100">
